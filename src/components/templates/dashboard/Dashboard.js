...
function Dashboard(props) {
  ...
  React.useEffect(() => {
    ...
    getAllUsers(context.user.email)
      .then(response => {
  ...
  return (
    <div className={classes.root}>
      ...
      >
        ...
        <Divider />
        <List>
          <MainListItems onUsers={onUsersListClick} onPets={onPetsListClick} />
        </List>
      </Drawer>
            ...
            {list ?
              <Grid item xs={12}>
                <Paper className={fixedHeightPaper}>
                  <MyPetsList pets={allPets} admin={true}/>
                </Paper>
              </Grid>
              :
              <Grid item xs={12}>
